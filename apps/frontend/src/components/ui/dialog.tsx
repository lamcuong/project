...
const DialogPortal = ({ className, ...props }: DialogPrimitive.DialogPortalProps) => (
  <DialogPrimitive.Portal tabIndex={-1} className={cn(className)} {...props} />
)
